...
void main()
{
  char Name[30][40] = {"Sam Matthews", "Mary McBeth", "Ying Phakpon","Chai Chanchai", "Tudchapan Leesontichai", "Apichaya Thamsuthon"}; 
  int ID[30] = {5301, 5302, 5303, 5304, 1062, 1070}; 
  float GPA[30] = {2.73, 2.35, 3.65, 3.24, 4.00, 3.80}; 
  int N = 6, i;
